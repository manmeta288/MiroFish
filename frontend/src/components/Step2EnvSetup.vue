  ...
  <div class="env-setup-panel">
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Simulation Initialising</span>
          </div>
        ...
        <div class="card-content">
          <p class="description">
            Create a simulation instance and load world parameter templates.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          <p class="description">
            Derives entity profiles from the knowledge graph and initialises agents with unique behaviours seeded from real-world data.
          </p>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            ...
            <div class="profiles-list">
              ...
              >
                ...
                <p class="profile-bio">{{ profile.bio || 'No description' }}</p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="description">
            LLM intelligently configures world time flow, recommendation algorithms, agent activity windows, and event triggers.
          </p>
              ...
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    ...
                    <div class="param-row">
                      <span class="param-label">Trending Weight</span>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Platform 2: Community</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Recency Weight</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="description">
            Generates initial activation events and trending topics to seed the simulation world state.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          <p class="description">Simulation environment ready. Click below to start.</p>
          
          <!-- Simulation rounds config (shown after config is generated) -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Rounds</span>
                <span class="section-desc">Auto-planned simulation of <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours. Each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> real-world minutes</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>For 100 agents, estimated runtime: {{ Math.round(customMaxRounds * 0.6) }} mins</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        Est. runtime for 100 agents: {{ Math.round(autoGeneratedRounds * 0.6) }} mins
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First run? Switch to Custom mode to reduce rounds for a quicker preview and lower error risk. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Display Age</span>
              <span class="info-value">{{ selectedProfile.age || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">Display Gender</span>
            ...
            <div class="info-item">
              <span class="info-label">Display MBTI</span>
          ...
          <div class="modal-section">
            ...
            <p class="section-bio">{{ selectedProfile.bio || 'No description' }}</p>
          </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">Detailed Profile</span>
            
            <!-- Persona dimension overview -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Full Event Experience</span>
                <span class="dim-desc">Complete behaviour trace in this event</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behaviour Pattern</span>
                <span class="dim-desc">Summary of experience and style preference</span>
              </div>
              <div class="dimension-card">
...
// Compute auto-generated rounds from config (not a hard-coded default)
...
// Calculate total topics across all agent personas
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Run simulation — auto rounds: ${autoGeneratedRounds.value}`)
  }
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Existing preparation found, reusing.')
      ...
      // Set expected total immediately (from prepare response)
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(`Read from knowledge graph: ${res.data.expected_entities_count} entities`)
...
const pollPrepareStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Parse phase info and log details
      if (data.progress_detail) {
        currentStage.value = data.progress_detail.current_stage_name || ''
        
        // Log detailed progress (deduplicated)
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Only update when API returns valid value to avoid overwriting existing data
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Log config generation phase (deduplicated)
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  ├─ Sim Duration: ${data.summary.simulation_hours} hrs`)
        ...
        if (data.config.time_config) {
          ...
          addLog(`Time config: ${tc.minutes_per_round} mins/round, ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)} rounds total`)
        }
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('✓ Environment setup complete — ready to run simulation')
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        if (res.data.summary) {
          ...
          addLog(`  ├─ Sim Duration: ${res.data.summary.simulation_hours} hrs`)
