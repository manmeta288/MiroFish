    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          <p class="description">
            LLM analyses the documents and simulation requirements to extract entities and auto-generate the ontology schema.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          <p class="description">
            Documents are chunked using the generated ontology. Entities and relationships are extracted and stored in the knowledge graph.
          </p>
