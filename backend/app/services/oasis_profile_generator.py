...
logger = get_logger('nodera.oasis_profile')
...
class OasisProfileGenerator:
    ...
    def __init__(
        ...
        self.zep_client = None  # Zep removed; kept for attribute compatibility
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """No-op: Zep removed. Entity context comes from Neo4j edges on the entity itself."""
